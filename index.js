...
case 'lofi':
			...
			case 'mapa': 
				...
				case 'adicionar':
					...
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args[0] === 'abrir') {
					    reply(`𝐒𝐄𝐗 𝐒𝐇𝐎𝐏🔥😈 aberto para membros`)
						client.groupSettingChange(from, GroupSettingChange.messageSend, false)
					} else if (args[0] === 'fechar') {
						reply(`𝐒𝐄𝐗 𝐒𝐇𝐎𝐏🔥😈 fechado SOMENTE ADM'S MANDA MSGS`)
           ...
           case 'rebaixar':
				...
				case 'promover':
					...
					if (mentioned.length > 1) {
						...
						mentions(`𝗇𝗈𝗏𝗈 𝖺𝖽𝗆 𝖿𝗆𝗅 𝗌𝖾𝗆 𝖾𝗌𝖼𝖺𝗇𝖽𝖺𝗅𝗈 @${mentioned[0].split('@')[0]} 𝘦𝘴𝘴𝘦 𝘮𝘢𝘮𝘰𝘶🍼 𝘰 𝘣𝘰𝘯𝘥𝘦 𝘱𝘳𝘢 𝘴𝘦𝘳 🤠𝘈𝘋𝘔`, mentioned, true)
						client.groupMakeAdmin(from, mentioned)
					}
					break	
			     	case 'kick':
			...
			case 'remover':
					...
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
							teks += `🌴𝗥𝗘𝗠𝗢𝗩𝗜 𝗠𝗘𝗦𝗠𝗢 𝗙𝗢𝗗𝗔-𝗦𝗘👋🏻🤠𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞 :\n`
							teks += `@_.split('@')[0]`
						}
						mentions(teks, mentioned, true)
						client.groupRemove(from, mentioned)
					} else {
						mentions(`🌴𝗥𝗘𝗠𝗢𝗩𝗜 𝗢 𝗟𝗜𝗫𝗢 @${mentioned[0].split('@')[0]} 𝗙𝗢𝗗𝗔-𝗦𝗘👋🏻😍 𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞𝗞`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'listadmin':
